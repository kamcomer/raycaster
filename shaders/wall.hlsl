// Wall shader for raycaster - textured walls
...
Texture2DArray wall_textures : register(t0, space0);
...
{
    float4 color = wall_textures.Sample(texture_sampler, float3(input.texcoord, input.tex_id));
